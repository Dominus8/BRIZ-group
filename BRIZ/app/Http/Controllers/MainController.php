        ...
        public function update_map(Request $request){
            MapModel::insert(array(
                ...
                ["id_region"=>"RU-ORL",   "name_region"=>"Орловская область", "status_region"=>0], 
                 ...
                 ["id_region"=>"SNG-KZ",   "name_region"=>"Казахстан",  "status_region"=>0],
                 ["id_region"=>"SNG-MG",   "name_region"=>"Монголия",  "status_region"=>0],
                 ["id_region"=>"SNG-UZ",   "name_region"=>"Узбекистан",  "status_region"=>0],
                 ["id_region"=>"SNG-KGZ",   "name_region"=>"Киргизия",  "status_region"=>0],
                 ["id_region"=>"SNG-TGS",   "name_region"=>"Таджикистан",  "status_region"=>0],
                 ["id_region"=>"SNG-TMS",   "name_region"=>"Туркменистан",  "status_region"=>0],
                 ["id_region"=>"SNG-AZ",   "name_region"=>"Азербайджан",  "status_region"=>0],
                 ["id_region"=>"SNG-AR",   "name_region"=>"Армения",  "status_region"=>0],
